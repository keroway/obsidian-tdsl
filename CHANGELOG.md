...
- **`THIRD-PARTY-NOTICES.md` version drift** — the recorded `@keroway/tdsl-wasm` version now matches the actual dependency in `package.json` ([#257](https://github.com/keroway/obsidian-tdsl/issues/257))
